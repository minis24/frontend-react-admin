				...
				(e.exports = function (e, n, i, a) {
					...
					y && (r(i, 'name') || t(i, 'name', n)),
						e[n] !== i &&
							...
							e === l ? (e[n] = i) : a ? (e[n] ? (e[n] = i) : t(e, n, i)) : (delete e[n], t(e, n, i)));
				...
				c = function (e, n, i) {
					...
					for (y in (u && (i = n), i))
						(h = ((p = !s && g && void 0 !== g[y]) ? g : i)[y]),
							(x = v && p ? a(h, l) : f && 'function' == typeof h ? a(Function.call, h) : h),
							g && o(g, y, h, e & c.U),
							m[y] != h && r(m, y, x),
							f && M[y] != h && (M[y] = h);
				};
		...
		function (e, n, i) {
			...
			e.exports =
				...
				function (e, n) {
					var i;
					return (
						null !== e ? ((a.prototype = l(e)), (i = new a()), (a.prototype = null), (i[o] = e)) : (i = c()),
						void 0 === n ? i : t(i, n)
					);
				};
		},
