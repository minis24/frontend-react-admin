//import { Api } from 'datatables.net-autofill-bs5';
import { useEffect, useRef, useState } from 'react';
import DataTable from 'datatables.net-bs5';
import { useAPI } from '@/app/store';
import url, { TUrl } from '@/domains/example/api/url';
import { IResponseField } from '@/domains/example/api/GET_FIELD';

const DataTablesDemo = () => {
	const { data, fetch } = useAPI<TUrl>(url.GET_FIELD);
	...
	useEffect(() => {
		if (data) {
			const listData = data.data.bdy as IResponseField;
			...
			<div className="col-12">
				<div className="card">
					<div className="border-bottom title-part-padding">
						<h4 className="card-title mb-0">DataTables Sample Table</h4>
					</div>
